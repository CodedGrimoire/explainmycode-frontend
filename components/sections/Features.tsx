...
const Features = () => {
  return (
    <section id="features" className="bg-slate-50 dark:bg-[#0a0f1a] py-24">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-4">
          {features.map((feature) => (
            <div
              key={feature.title}
              className="group rounded-xl border border-slate-200 bg-white p-8 transition-all hover:border-primary/50 dark:border-slate-800 dark:bg-background-dark"
            >
